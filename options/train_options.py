...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--jitter_brightness_range', default='0.6,1.4')
        parser.add_argument('--jitter_contrast_range', default='0.7,1.3')
        parser.add_argument('--jitter_saturation_range', default='0.7,1.3')
        parser.add_argument('--jitter_hue_range', default='-0.1,0.1')
