...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--blur_sig', default='0.0,2.0')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='/mnt/d8e41ed2-2843-4501-b615-1b3bb7a14c66/yyw/checkpoint/UnivFD_inter', help='models are saved here')
